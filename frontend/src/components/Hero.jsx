...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center bg-cover bg-center min-h-screen text-center" style={{ backgroundImage: `url(${heroImage})` }}>
      ...
      <h1 className="relative text-6xl font-bold text-amber-500 mt-4 px-2">Welcome to Louise's Corner</h1>
      <p className="relative text-orange-400 text-3xl mt-8">Where grilled perfection meets rustic charm</p>
